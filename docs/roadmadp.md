...
- serialize は常に V2、未知 version、必須 field 欠落、未知 nested field を拒否
...
1. M1 / M2 の worktree diff を確認し、必要なら milestone 規約に沿って commit する
2. M3 の対象 domain と detailed design を決める
