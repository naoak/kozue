...
- M2 時点の serialize は V2（M3a1 で V3、M3a2a-I で V4 へ更新）、未知 version、必須 field 欠落、
  未知 nested field を拒否
...
状態: **M3a2a-I（Graph rectangle shapes）実装済み**
...
1. Graph / Flowchart
   ...
   - **M3a2 次候補**:
     - Circle / Diamond などの追加 shape、subgraph / container、port
...
2. shape-aware endpoint clipping と Scene primitive / stroke contract を確定する
